...
async def test_multi_collection():
	...
	try:
		...
		print(f'✅ Query results from {collection_1}: {len(results_1.results)} documents found')
		...
		print(f'✅ Query results from {collection_2}: {len(results_2.results)} documents found')
		...
		isolation_results_1 = await kb_repo_1.query(isolation_query, collection_id=collection_1)
		...
		print(f'   📄 Collection 1 searching for collection 2 content: {len(isolation_results_1.results)} results')
		print(f'   📄 Collection 2 searching for collection 1 content: {len(isolation_results_2.results)} results')

...
DB_NAME = os.getenv('DB_NAME', 'frecord_v2')
...
GOOGLE_REDIRECT_URI = 'https://meobeo.ai/api/v1/auth/google/callback'

# Frontend redirect URLs for OAuth flows - updated for test page on port 5501
FRONTEND_SUCCESS_URL = os.getenv('FRONTEND_SUCCESS_URL', 'http://localhost:5501/static/google_auth_test/success.html')
FRONTEND_ERROR_URL = os.getenv('FRONTEND_ERROR_URL', 'http://localhost:5501/static/google_auth_test/error.html')

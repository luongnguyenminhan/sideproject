...
class FacebookRepo(BaseRepo):
    ...
    async def get_page_info_with_posts(self, limit: int = 5) -> FacebookPageInfo:
        ...
        """
        print(
            f"\033[94mINFO: Fetching Facebook page info with {limit} posts for page_id: {self.page_id}\033[0m"
        )
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                print(
                    f"\033[96mDEBUG: Facebook API response status: {response.status_code}\033[0m"
                )

                if response.status_code == 404:
                    print(
                        f"\033[91mERROR: Facebook page not found: {self.page_id}\033[0m"
                    )
                ...
                print(
                    f"\033[92mINFO: Successfully cached page info for {self.cache_ttl} seconds\033[0m"
                )

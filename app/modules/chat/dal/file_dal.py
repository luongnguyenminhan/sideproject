...
class FileDAL(BaseDAL[File]):
	...
	def get_conversation_files(
		...
		logger.info(f'\033[93m[FileDAL.get_conversation_files] Getting files for conversation: {conversation_id}, user: {user_id}, page: {page}, page_size: {page_size}, file_type: {file_type}, search: {search}\033[0m')

            ...
            while True:
                ...
                if message_data.get("type") == "chat_message":
                    ...
                    try:
                        ...
                        print(
                            f"\033[95m[websocket_chat_endpoint] Getting AI response\033[0m"
                        )
                        ...
                        print(
                            f"\033[92m[websocket_chat_endpoint] AI response received: {ai_response.get('model_used', 'unknown_model')}\033[0m"
                        )
...
async def send_message(
    ...
    try:
        ...
        print(
            f"\033[92m[send_message] AI response received: {ai_response.get('model_used', 'unknown_model')}\033[0m"
        )

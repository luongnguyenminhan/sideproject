...
async def upload_cv_for_chat(
	...
	try:
		...
		if conversation_id:
			...
			await cv_service.store_cv_context(conversation_id, user_id, cv_data.get('cv_analysis_result', {}))
		...
		response_experience_count = len(cv_data['cv_analysis_result'].work_experience_history.items)

        ...
        {pageInfo && (
          <ScrollReveal direction="up" delay={0.2}>
            <div className="mb-12 relative">
              <AnimatedRibbon count={3} thickness={20} speed={0.3} className="opacity-30" />
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-4 flex-wrap">
                              <MagneticCard strength={8}>
                                <div className="flex items-center gap-2 bg-gradient-to-r from-[color:var(--feature-blue)] to-[color:var(--feature-blue)]/80 px-4 py-2 rounded-full group relative overflow-hidden">
                                  ...
                                  <svg className="w-5 h-5 text-[color:var(--feature-blue-text)] relative z-10" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                                  </svg>
                                  <span className="text-sm font-semibold text-[color:var(--feature-blue-text)] relative z-10">
                                    {pageInfo.followers_count?.toLocaleString()} {t('aboutUs.social.followers') || 'followers'}
                                  </span>
                                </div>
                              </MagneticCard>
                              ...
                              {pageInfo.emails?.[0] && (
                                <MagneticCard strength={8}>
                                  <div className="flex items-center gap-2 bg-gradient-to-r from-[color:var(--feature-green)] to-[color:var(--feature-green)]/80 px-4 py-2 rounded-full group relative overflow-hidden">
                                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                                    <svg className="w-4 h-4 text-[color:var(--feature-green-text)] relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <ScrollReveal direction="up" delay={0.8}>
                      <div className="pt-6 border-t border-[color:var(--border)]">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          ...
                          {/* Facebook Link */}
                          <MagneticCard strength={15}>
                            <div className="text-center p-6 bg-gradient-to-br from-[color:var(--feature-blue)] to-[color:var(--feature-blue)]/80 rounded-2xl group relative overflow-hidden transition-all duration-500 hover:shadow-lg hover:scale-105">
                              ...
                              >
                                <div className="w-10 h-10 mx-auto mb-3 bg-white/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                  <svg className="w-6 h-6 text-[color:var(--feature-blue-text)]" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                  </svg>
                                </div>
                                <span className="text-sm font-semibold text-[color:var(--feature-blue-text)]">Facebook</span>
                              </a>
                            </div>
                          </MagneticCard>
                          ...
                          {pageInfo.single_line_address && (
                            <MagneticCard strength={15}>
                              <div className="text-center p-6 bg-gradient-to-br from-[color:var(--feature-yellow)] to-[color:var(--feature-yellow)]/80 rounded-2xl group relative overflow-hidden transition-all duration-500 hover:shadow-lg hover:scale-105">
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                                <div className="relative z-10">
                                  ...
                                  <span className="text-sm font-semibold text-[color:var(--feature-yellow-text)] block">
                                    {pageInfo.single_line_address}
                                  </span>
                                </div>
                              </div>
                          ...
                          {pageInfo.emails && pageInfo.emails.length > 0 && (
                            <MagneticCard strength={15}>
                              <div className="text-center p-6 bg-gradient-to-br from-[color:var(--feature-green)] to-[color:var(--feature-green)]/80 rounded-2xl group relative overflow-hidden transition-all duration-500 hover:shadow-lg hover:scale-105">
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                                <div className="relative z-10">
                                  <div className="w-10 h-10 mx-auto mb-3 bg-white/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                  ...
                                  <span className="text-sm font-semibold text-[color:var(--feature-green-text)] block">
                                    {t('aboutUs.contact') || 'Contact'}
                                  </span>
                                </div>
                              </div>
                            </MagneticCard>

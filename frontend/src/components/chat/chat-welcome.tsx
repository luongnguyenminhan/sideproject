...
export function ChatWelcome({ welcomeTitle, welcomeDescription }: ChatWelcomeProps) {
  return (
    <div className="flex-1 flex items-center justify-center h-full bg-gradient-to-br from-[color:var(--gradient-bg-from)] via-[color:var(--gradient-bg-via)] to-[color:var(--gradient-bg-to)]">

        ...
        >
          ...
          <div className='flex flex-col text-right'>
            <div className='flex items-center gap-1'>
              ...
              {currentUser.rank && (
                <span className='inline-flex uppercase items-center px-1.5 py-0.5 rounded-full text-[9px] font-medium bg-gradient-to-r from-amber-400 to-orange-500 text-white'>
                  {currentUser.rank}
                </span>
              )}
            </div>

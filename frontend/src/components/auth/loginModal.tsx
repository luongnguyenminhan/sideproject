...
export default function LoginModal({
  ...
  useEffect(() => {
    const handleMessage = async (event: MessageEvent) => {
      ...
      const allowedOrigins = [new URL(apiBaseUrl).origin, window.location.origin];
      ...
      if (event.data && event.data.type === 'GOOGLE_AUTH_SUCCESS' && event.data.accessToken) {
        try {
          dispatch(loginStart());
          setIsLoading(true);
            ...
            dispatch(
              loginSuccess({
                user: {
                  ...
                  rank: userDetails.rank ? userDetails.rank.toString() : undefined,
                },
              }),
            );
          ...
          <div className='w-full mt-8'>
            <Button
              ...
              style={{
                ...
                borderRadius: '16px',
                border: 'none',
                background: isLoading ? '#e5e7eb' : '#ffffff',
            ...
            >
              <div className='flex items-center justify-center gap-3'>
                {isLoading ? (
                  ...
                  <>
                    <FontAwesomeIcon icon={faGoogle} className='text-[#4285f4]' size='lg' />

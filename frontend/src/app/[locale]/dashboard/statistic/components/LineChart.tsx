...
const LineChart = ({ chartData, options }: LineChartProps) => {
  ...
  return (
    <div className='px-4 py-2'>
      <div className='mb-6'>
        <h3 className='text-xl font-bold text-gray-800'>{TEXT_TRANSLATE.LINE_CHART.TITLE}</h3>
        <p className='mt-1 text-sm text-gray-500'>{TEXT_TRANSLATE.LINE_CHART.SUB_TITLE}</p>
      </div>
      <div className='h-96'>
